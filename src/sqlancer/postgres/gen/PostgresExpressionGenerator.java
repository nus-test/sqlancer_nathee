...
//                    generateExpression(depth + 1, PostgresDataType.RANGE));
    ...
    private PostgresExpression getComparison(PostgresExpression leftExpr, PostgresExpression rightExpr) {
        ...
        //     return new PostgresCollate(op, "C"); // E00
        // }
        return op;
    }
    ...
    public PostgresExpression generateExpression(int depth, PostgresDataType originalType) {
        ...
        //     return potentiallyWrapInCollate(dataType, createColumnOfType(dataType)); // E00
        // }
...
//            return new PostgresCollate(exprInternal, "C"); // E00
//        } else {
            return exprInternal;
//        }
    }
...
//        case BIT: // T03
            if (Randomly.getBoolean() || PostgresProvider.generateOnlyKnown /*
                ...
                return PostgresCompoundDataType.create(type, (int) Randomly.getNotCachedInteger(1, 255)); // T06
            }
        default:
...
//    }
    ...
    private enum TextExpression {
        CAST, FUNCTION, CONCAT//, COLLATE // E00
    }
    ...
    private PostgresExpression generateTextExpression(int depth) {
        ...
        // if (expectedResult) {
        //     validOptions.remove(TextExpression.COLLATE); // E00
        // }
