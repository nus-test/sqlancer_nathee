...
public class PostgresAggregate extends FunctionNode<PostgresAggregateFunction, PostgresExpression>
    ...
    public enum PostgresAggregateFunction {
        AVG(PostgresDataType.INT, PostgresDataType.FLOAT, PostgresDataType.REAL/*, PostgresDataType.DECIMAL*/), // T08
        ...
        // STRING_AGG
        SUM(PostgresDataType.INT, PostgresDataType.FLOAT, PostgresDataType.REAL/*, PostgresDataType.DECIMAL*/); // T08
