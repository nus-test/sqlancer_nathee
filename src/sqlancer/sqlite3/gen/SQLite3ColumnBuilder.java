...
public class SQLite3ColumnBuilder {
    ...
    public String createColumn(String columnName, SQLite3GlobalState globalState, List<SQLite3Column> columns) {
        ...
        sb.append(" ");
        String dataType = Randomly.fromOptions("INT"/*, "TEXT"*/, "VARCHAR(255)"/*, "BLOB"*/, "DOUBLE PRECISION"/*, "REAL"*/, "INTEGER"); // T02, T03, T05, T06, T08
        sb.append(dataType);
        ...
        // if (Randomly.getBooleanWithSmallProbability()) {
        //     String randomCollate = SQLite3Common.getRandomCollate(); // CT00
