...
public class MySQLTableGenerator {
    ...
    private void appendTypeString(MySQLDataType randomType) {
        ...
        case INT:
            ...
            break;
        case VARCHAR:
            sb.append(Randomly.fromOptions("VARCHAR(255)"/*, "TINYTEXT", "TEXT", "MEDIUMTEXT", "LONGTEXT"*/)); // T02, T06
            break;
        case FLOAT:
            // sb.append("FLOAT");
            // optionallyAddPrecisionAndScale(sb); // T08
            // break;
        case DOUBLE:
            sb.append(Randomly.fromOptions("DOUBLE PRECISION"/*, "FLOAT"*/)); // T04, T08
            optionallyAddPrecisionAndScale(sb);
            break;
        default:
            throw new AssertionError();
